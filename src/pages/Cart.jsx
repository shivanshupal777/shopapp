...
const Cart = () => {
  ...
  return (
    <div>{
        ...
        <h1 className="font-semibold font-3xl">CART EMPTY</h1>
        <Link to={"/"}>
            <button className="w-[120px] bg-green-400 rounded-lg h-[39px]
            hover:bg-slate-500 hover:text-white transition duration-200 ease-in">
                SHOP NOW
            </button>
        </Link>
        </div>)
